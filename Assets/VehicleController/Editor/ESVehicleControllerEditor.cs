...
public class ESVehicleControllerEditor : Editor
{
    ...
    public void ESVehicleCtrlCustomInspector(ESVehicleController ESVC)
    {
        ...
        switch (tab)
        {
            ...
            case 0:
                {
                    EditorGUILayout.HelpBox("go to 'Edit/ProjectSettings/Time' and apply this value below \n -FixedTimeStep =0.0025f \n -MaximumAllowedTime = 0.3333333f \n -TimeScale = 1f, -Maximum Particles = 0.3f",MessageType.Info);
                    GUILayout.Space(6);
                    EditorGUILayout.HelpBox("NOTE: \n -MaxSpeed and MaxEngineTorque has been moved to ESGearShift", MessageType.Info);
                    //
                    GUILayout.Space(6);
                    GUILayout.Label("Thanks for Choosing Easy Vehicle System", EditorStyles.boldLabel);
                }
             break;
            case 1:
                {
